...
func spawn_hide():
	var hide_spawner = drops.instantiate()
	hide_spawner.global_position = $hurtbox/coll.global_position
	get_tree().current_scene.call_deferred('add_child', hide_spawner)
